...
describe("MdDate - deserialize - parseObjectsIsoDateToMdDate", () => {
    ...
    it("parseObjectsIsoDateToMdDate - Parse object 1", () => {
    ...
    it("parseObjectsIsoDateToMdDate - Parse object 2", () => {
        const sampleIsoDate = "2012-12-12T12:12:12";
        const employee = {
            name: "Sheraz",
            dob: sampleIsoDate,
            hireDate: sampleIsoDate,
    ...
    it("parseObjectsIsoDateToMdDate - Parse object 3", () => {
        const sampleIsoDate = "2012-12-12T12:12";
        const employee = {
            name: "Sheraz",
            dob: sampleIsoDate,
            hireDate: sampleIsoDate,
